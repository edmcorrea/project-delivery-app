...
<details>
  ...
  - Data de entrega para avaliação final do projeto: `14/02/2023 14:00`.
...
<details>
  ...
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-022-a-project-delivery-app`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-022-a-project-delivery-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-022-a-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-022-a-project-delivery-app/back-end/package.json`
    - `sd-022-a-project-delivery-app/front-end/package.json`
...
<details>
  ...
  O data-testid de cada elemento que será usado na avaliação do projeto está no arquivo [data-testids.txt](data-testids.txt) na raiz do projeto. Cada um desse elementos tem no [protótipo do figma](#construção-do-front-end) um número, e nesse arquivo, o `data-testid` que deve ser atribuído ao valor de tal. 
